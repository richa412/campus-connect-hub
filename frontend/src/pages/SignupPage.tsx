        ...
        <div className="flex flex-1 items-center justify-center p-6 sm:p-8">
          <div className="w-full max-w-sm">
            ...
            <div className={cn("p-6 sm:p-8", glassCard)}>
              <h1 className="mb-1 text-2xl font-bold tracking-tight">Create account</h1>
              <p className="mb-8 text-sm text-gray-400 sm:text-base">Use your college email to join</p>
              <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  {email && !isEduEmail && (
                    <p className="text-[10px] font-bold text-rose-500 uppercase tracking-widest">Please use a valid college email (.edu or .ac.)</p>
                  )}
                </div>
                <div className="space-y-2">
                ...
                <Button
                  type="submit"
                  size="lg"
                  disabled={!isEduEmail || !name || password.length < 8}
